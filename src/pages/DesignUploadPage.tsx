...
const UploadDesignPage: React.FC = () => {
  ...
  const loadStores = async () => {
    try {
      ...
      // Eğer mağaza varsa ilk mağazayı seç
  ...
  const loadImageFolders = async () => {
    try {
      ...
      const mockFolders: ImageFolder[] = [
        { id: 'folder1', name: 'Logos', path: 'logos' },
        { id: 'folder2', name: 'Banners', path: 'banners' },
        { id: 'folder3', name: 'Backgrounds', path: 'backgrounds' },
        { id: 'folder4', name: 'Watermarks', path: 'watermarks' }
      ];
      
      setImageFolders(mockFolders);
    } catch (error) {
      console.error('❌ Image folders loading error:', error);
    }
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center">
                    <FileUp className="h-4 w-4 mr-2 text-orange-500" />
                    Listeleme Şablonu
                  </label>
                  <select
                  ...
                  >
                    ...
                    <option value="template1">Vintage Poster Template</option>
                    <option value="template2">Modern Typography Template</option>
                    <option value="template3">Botanical Illustrations Template</option>
                  </select>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  >
                    <option value="">Klasör seçin...</option>
                    <option value="folder1">T-Shirts</option>
                    <option value="folder2">Mugs</option>
                    <option value="folder3">Posters</option>
                  </select>
                </div>
