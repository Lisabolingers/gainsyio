...
import { Upload, Trash2, Download, Search, Filter, Grid, List, RefreshCw, AlertCircle, Clock, CheckCircle, X, Image as ImageIcon, FileUp, FileDown, Store, Folder } from 'lucide-react';
...
const UploadDesignPage: React.FC = () => {
  ...
  // New states for store and folder selection
  ...
  const loadStores = async () => {
    try {
      ...
      const mockStores: EtsyStore[] = [
        { id: 'store1', store_name: 'My Etsy Store', is_active: true },
        { id: 'store2', store_name: 'My Second Store', is_active: true }
      ];
  ...
  const loadImageFolders = async () => {
    try {
      ...
      const mockFolders: StoreImageFolder[] = [
        { id: 'folder1', name: 'Logos', path: 'logos', image_count: 5 },
        { id: 'folder2', name: 'Banners', path: 'banners', image_count: 3 },
        { id: 'folder3', name: 'Product Images', path: 'products', image_count: 12 },
        { id: 'folder4', name: 'Backgrounds', path: 'backgrounds', image_count: 7 }
      ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <div className="flex items-center mb-2">
            ...
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Listeleme Şablonu</h2>
          </div>
          <select
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500"
          >
            <option value="">Şablon seçin...</option>
            <option value="template1">Bold Typography</option>
            <option value="template2">Minimalist Design</option>
        ...
        <div>
          <div className="flex items-center mb-2">
            ...
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Mockup Klasörü</h2>
          </div>
          <select
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500"
          >
            <option value="">Klasör seçin...</option>
            <option value="folder1">Posters</option>
            <option value="folder2">T-Shirts</option>
            <option value="folder3">Mugs</option>
          </select>
        </div>
      </div>

      {/* Shop Images Folder and Choose Shop */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <div className="flex items-center mb-2">
            <Folder className="h-5 w-5 text-orange-500 mr-2" />
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Shop Images Folder</h2>
          </div>
          <select
        ...
        <div>
          <div className="flex items-center mb-2">
            ...
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Choose Shop</h2>
          </div>
          <select
            value={selectedStore}
